...
<div class="body-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-3">
        <button type="button" class="btn btn-primary btn-lg add" data-bs-toggle="modal" data-bs-target="#form-modal">
          Add Employe
        </button>
      </div>
    </div>
          ...
          <div class="card-body p-4">
            ...
            <div class="table-responsive">
              ...
              <table class="table  mb-0 align-middle">
                <thead class="text-dark text-center fs-4">
                  <tr>
                    ...
                    <tr>
                      ...
                      <td class="border-bottom-0">
                        <div class="d-flex align-items-center gap-2">
                          <span class="badge bg-primary <?= $employe['employe_status'] == 'Fired' ? 'bg-danger' : '' ?> rounded-3 fw-semibold">
                      ...
                      <td>
                        ...
                        <a href="<?= BASEURL; ?>/employe/fire/<?= $employe['id_employe']; ?>" class="btn btn-danger">Fire</a>
                        <a href="<?= BASEURL; ?>/employe/update/<?= $employe['id_employe']; ?>"
                          class="btn btn-success update" data-bs-toggle="modal" data-bs-target="#form-modal"
                          data-id="<?= $employe['id_employe'] ?>">Update</a>
                      </td>
                    </tr>
      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>/employe/add" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" autocomplete="true" required="true" class="form-control" id="name" placeholder="Name"
              name="name">
          </div>

          <div class="mb-3">
            <label for="id_occupation" class="form-label">Occupation :</label>
            <select class="form-select" aria-label="Default select example" id="id_occupation" name="id_occupation">
